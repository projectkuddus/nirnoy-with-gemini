-- ============================================================
-- NIRNOY HEALTH PLATFORM - COMPLETE PRODUCTION SCHEMA
-- Designed for 1000+ concurrent paid users
-- All data in Supabase PostgreSQL - NO localStorage
-- ============================================================
...
CREATE TABLE public.patients (
  ...
  subscription_tier VARCHAR(20) DEFAULT 'free' CHECK (subscription_tier IN ('free', 'basic', 'premium', 'family')),
